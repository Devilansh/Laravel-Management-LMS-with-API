                ...
                <div class="toggle-expand-content" data-content="pageMenu">
                    <ul class="nk-block-tools g-3">
                            ...
                            <div class="drodown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <ul class="link-list-opt no-bdr">
                                        ...
                                        <li><a href="#"><span>Mobile
                                                    Application</span></a></li>
                                        <li><a href="#"><span>Graphics Design</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <li class="nk-block-tools-opt d-none d-sm-block">
                            <a class="btn btn-primary" data-bs-toggle="modal" href="#modalCreate"><em class="icon ni ni-plus"></em><span>Add
                                    Category</span></a>
                        </li>
            ...
            <div class="card h-100">
                <div class="card-inner">
                    ...
                    <!-- <ul class="d-flex flex-wrap g-1">
                        <li><span class="badge badge-dim bg-primary">Photoshop</span>
                        </li>
                        <li><span class="badge badge-dim bg-danger">Adobe
                                Illustrator</span></li>
                        <li><span class="badge badge-dim bg-info">Logo Design</span>
                        </li>
        ...
        <div class="col-sm-6 col-lg-4 col-xxl-3">
            <div class="card h-100">
                <div class="card-inner">
                    ...
                    <p>Website Design & Develop the website with web applications</p>
                    <!-- <ul class="d-flex flex-wrap g-1">
                        <li><span class="badge badge-dim bg-primary">Responsive
                                Design</span></li>
                        <li><span class="badge badge-dim bg-danger">Wordpress
                                Customization</span>
                        </li>
                        <li><span class="badge badge-dim bg-info">Theme
                                Development</span></li>
                        <li><span class="badge badge-dim bg-warning">Bootstrap</span>
                        </li>
                        <li><span class="badge badge-dim bg-secondary">HTML & CSS
                                Grid</span></li>
                    </ul> -->
                </div>
            </div>
        ...
        <div class="col-sm-6 col-lg-4 col-xxl-3">
            <div class="card h-100">
                <div class="card-inner">
                    ...
                    <p>Website Design & Develop the website with web applications</p>
                    <!-- <ul class="d-flex flex-wrap g-1">
                        <li><span class="badge badge-dim bg-primary">Mobile App
                                Design</span></li>
                        <li><span class="badge badge-dim bg-danger">User
                                Interface</span></li>
                        <li><span class="badge badge-dim bg-info">Design Thinking</span>
                        </li>
                        <li><span class="badge badge-dim bg-warning">Prototyping</span>
                        </li>
                    </ul> -->
                </div>
            </div>
