                ...
                <div class="toggle-expand-content" data-content="more-options">
                    <ul class="nk-block-tools g-3">
                        ...
                        <li class="nk-block-tools-opt">
                            ...
                            <a class="btn btn-primary d-none d-md-inline-flex" data-bs-toggle="modal" href="#teacher-add"><em class="icon ni ni-plus"></em><span>Add</span></a>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <ul class="nk-tb-actions gx-1">
                                ...
                                <li>
                                    <div class="drodown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <ul class="link-list-opt no-bdr">
                                                <li><a href="./teacher-details.php"><em class="icon ni ni-eye"></em><span>View
                                                            Details</span></a></li>
...
<div class="modal fade" role="dialog" id="teacher-add">
