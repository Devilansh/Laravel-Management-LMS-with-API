            ...
            <div class="toggle-wrap nk-block-tools-toggle">
                ...
                <div class="toggle-expand-content" data-content="pageMenu">
                    <ul class="nk-block-tools g-3">
                        ...
                        <li class="nk-block-tools-opt"><a href="#" class="btn btn-primary"><em class="icon ni ni-reports"></em><span>Reports</span></a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="data">
                                    <div class="data-group">
                                        ...
                                        <div class="info text-end">
                                            <span class="change up text-danger"><em class="icon ni ni-arrow-long-up"></em>4.63%</span><br><span>vs.
                                                last month</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-inner pb-0">
                                ...
                                <div class="data">
                                    <div class="data-group">
                                        ...
                                        <div class="info text-end"><span class="change up text-danger"><em class="icon ni ni-arrow-long-up"></em>7.13%</span><br><span>vs.
                                                last week</span></div>
                                    </div>
                                </div>
                            </div><!-- .card-inner -->
                    ...
                    <div class="card-inner card-inner-md">
                        <div class="review-item d-flex justify-content-between">
                            <div class="user-card">
                                ...
                                <div class="user-info">
                                    <span class="lead-text">Mr. Testing</span>
                        ...
                        <div class="review-item d-flex justify-content-between">
                            ...
                            <div class="review-status">
                                <ul class="review-stars d-flex">
                                    ...
                                    <li><em class="icon ni ni-star-half-fill text-warning"></em>
                                    </li>
                                </ul>
